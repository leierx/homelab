...
resource "incus_instance" "test_slave_01" {
  name    = "hadron-slave-test01"
  type    = "virtual-machine"
  image   = incus_image.kairos.fingerprint
  running = true
...
resource "incus_instance" "test_slave_02" {
  name    = "hadron-slave-test02"
  type    = "virtual-machine"
  image   = incus_image.kairos.fingerprint
  running = true
